...
class Programas():
    ...
    def Sostenimiento(self):
        ventana = Toplevel()
        ventana.title("Sostenimiento | Erick Tocasca")
        ventana.iconbitmap("../Imagenes/lobo.ico")
        ...
        # CREACIÓN DE IMAGENES
        imagen = Image.open("../Imagenes/shotcrete.jpg")
        render = ImageTk.PhotoImage(imagen)       
        Label(Frame2, image = render).grid(row=0, column=0)
        
        imagen1 = Image.open("../Imagenes/formula_shotcrete.jpg")
        render1 = ImageTk.PhotoImage(imagen1)       
        Label(Frame3, image = render1).grid(row=0, column=11, columnspan=11, sticky=NE)
        ...
        # CREACIÓN DE LABELS PARA INPUTS
        label1 = Label(Frame4, text="Altura m")
        label1.config(fg = "black",
                bg = "khaki1",
                font = ("Black Arial",10),
                padx = 25,
        ...
        label10 = Label(Frame4, text="Radio m")
        ...
        entry10 = Entry(Frame4)
        entry10.grid(row=2, column=1)
        separador10 = Label(Frame4)
        separador10.grid(row=3)
        
        label2 = Label(Frame4, text="Ancho m")
        label2.config(fg = "black",
                bg = "khaki1",
                font = ("Black Arial",10),
                padx = 25,
        ...
        label3 = Label(Frame4, text="Longitud m")
        label3.config(fg = "black",
                bg = "khaki1",
                font = ("Black Arial",10),
                padx = 25,
        ...
        label4 = Label(Frame4, text="Rugosidad %")
        label4.config(fg = "black",
                bg = "khaki1",
                font = ("Black Arial",10),
                padx = 2,
        ...
        label5 = Label(Frame4, text="Rebote %")
        ...
        label7 = Label(Frame4, text="Compactación %")
        ...
        label8 = Label(Frame4, text="Espesor m")
        ...
        label23 = Label(Frame6, text="Volumen de \nShotcrete: ")
        ...
        # COMANDO CALCULAR
        def calcular():
            P = 2* float(entry1.get()) - float(entry10.get()) * (4 - np.pi) + float(entry2,get())
            V = np.round((P*float(entry3.get())*float(entry4.get())*float(entry5.get())*float(entry6.get())*float(entry7.get())*float(entry8get())), decimals=2)
            
            re4 = Label(Frame6, text=V)
            re4.grid(row=6, column=1)
            un4 = Label(Frame6, text="Volumen m3")
            un4.grid(row=6, column=2)
